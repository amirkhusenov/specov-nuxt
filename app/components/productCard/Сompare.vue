...
<template>
  <button
    class="flex justify-center items-center bg-white hover:text-(--Brand-600) transition text-(--Brand-950) shadow-[0_1px_3px_0_rgba(10,13,18,0.10),0_1px_2px_-1px_rgba(10,13,18,0.10)] p-2 rounded-full cursor-pointer">
