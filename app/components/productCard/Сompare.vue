...
<template>
  <button
    class="flex justify-center items-center bg-white shadow-[0_1px_3px_0_rgba(10,13,18,0.10),0_1px_2px_-1px_rgba(10,13,18,0.10)] p-2 rounded-full cursor-pointer">
    <div class="h-5 w-5"><svg width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 20 20" fill="none"
        ...
        <path
          ...
          stroke="#053628" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"></path>
      </svg>
    </div>
  </button>
</template>