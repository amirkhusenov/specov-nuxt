  ...
  <div class="flex items-center overflow-hidden">
    ...
    <div class="flex relative w-0 flex-col items-end cursor-pointer">
      ...
      <button @click="shiftMenu" :class="[isShift ? 'rotate-180' : '']"
        class="z-2 transition border-zinc-300 p-[5px] flex justify-center h-8 w-8 flex-col bg-white hover:bg-gray-300 items-center border border-solid rounded-full cursor-pointer">
